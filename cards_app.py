...
.anim-attack .flip-card-inner { animation: lungeUp 0.5s ease forwards; }
.anim-damage .flip-card-inner { animation: shakeDamage 0.5s ease forwards; }
